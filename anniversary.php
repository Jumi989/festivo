...
<body class="bg-gradient-to-r from-rose-950 via-stone-300  via-neutral-300 to-rose-950">
    ...
    <div class="container mx-auto px-6 py-4">
        ...
        <div class=" backdrop-blur- bg-white/20 shadow-md rounded-lg p-4">
           ...
           <!-- Package Card -->
           <div class=" backdrop-blur- bg-white/20 shadow-md rounded-lg p-4">
                <img src="./pics/versary4.jpeg" alt="Wedding Package" class="w-full h-40 object-cover rounded-md">
           ...
           <!-- Package Card -->
           <div class=" backdrop-blur- bg-white/20 shadow-md rounded-lg p-4">
                <img src="./pics/versary5.avif" alt="Wedding Package" class="w-full h-40 object-cover rounded-md">
                <h2 class="text-lg font-bold mt-2">Me n U</h2>
                <div class="rating rating-xs">
                    <input type="radio" name="rating-1" class="mask mask-star-2 bg-orange-400" aria-label="1 star" />
                    <input type="radio" name="rating-1" class="mask mask-star-2 bg-orange-400" aria-label="2 star"
