...
<body>
  ...
  <div class="container mx-auto grid grid-cols-3 gap-4">
    ...
    <a href="./birthday.php" class="card bg-base-100  w-96 shadow-sm hover:scale-[1.1] duration-400 ease-out transition">
      <figure>
    ...
    <a href="./otherevents.php"  class="card bg-base-100  w-96 shadow-sm hover:scale-[1.1] duration-400 ease-out transition">
      <figure>
