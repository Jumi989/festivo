      ...
      <div class="hero-content text-neutral-content text-center">
        <div class="card backdrop-blur- bg-white/15 w-[900px] h-122 rounded-md">
            ...
            <form action="book_form.php" method="post" class="card-body justify-center items-center ">
                <h2 class="text-2xl ">Add a package</h2>
              <fieldset class="fieldset w-[800px] gap-6 grid grid-cols-2">
                <div>
                  <label class="fieldset-label text-base ">Name</label>
                  <input type="Name" class="input w-full" name="name" placeholder="enter package name" />
                  <label class="fieldset-label text-base ">Price</label>
                  <input type="price" class="input w-full" name="price" placeholder="enter price" />
                  <label class="fieldset-label text-base" >photo</label>
                  <input type="file" id="picture" class="input w-full" name="photo" accept="image/*" placeholder="Enter your address" />
                  </div>
              </fieldset>
