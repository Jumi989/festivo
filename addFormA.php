...
<html lang="en" data-theme="dark">
   ...
   <body>
    <div class="hero min-h-screen" style="background-image: url(./pics/form.jpg)">
      ...
      <div class="hero-content text-neutral-content text-center">
        ...
        <form action="addA.php" method="post" enctype="multipart/form-data" class="card-body flex flex-col items-center">
  <h2 class="text-2xl mb-4 text-center">Add a Anniversary Package</h2>
  ...
  <fieldset class="space-y-4 w-72">
    ...
    <div class="flex flex-col">
      <label class="text-base text-center">Price</label>
      <input type="text" class="input w-full" name="price" placeholder="Price" required/>
    </div>
