   ...
   <body>
    <div class="hero min-h-screen" style="background-image: url(./pics/form.jpg)">
      ...
      <div class="hero-content text-neutral-content text-center">
        ...
        <form action="addB.php" method="post" enctype="multipart/form-data" class="card-body flex flex-col items-center">
  <h2 class="text-2xl mb-4 text-center">Add a Birthday Package</h2>
